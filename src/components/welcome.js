  ...
  return (
    <section className="welcome">
      ...
      <div className="welcome__grafic">
        ...
        <img src={Path3} className="w-Pnalet3" rel="preload" alt='start-yellow-img'/>
        <img src={Path4} className="w-Pnalet4" rel="preload" alt='start-red-img'/>
        <img src={Path5} className="w-Pnalet5" rel="preload" alt='start-blue-img'/>
        <img src={Path6} className="w-Pnalet6" rel="preload" alt='start-white-img'/>
        <img src={Path6} className="w-Pnalet7" rel="preload" alt='start-white-img'/>
        <img src={Path4} className="w-Pnalet8" rel="preload" alt='start-red-img'/>
        <img
          src={WelcomeBG}
          className="WelcomeBG"
          alt="backgroundIamge"
