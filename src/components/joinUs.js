        ...
        <section className='join-us'>
            ...
            <div  className='join-us__form'>
                ...
                <div className='join-us__select__block'>
                    <p className='join-us__select__block__item'>Trading pools</p>
                    <p className='join-us__select__block__item--center'>Covered calls</p>
                    <p className='join-us__select__block__item'>Lending</p>
                </div>
                <div className='join-us__table'>
                    {/* <input type='radio'/> */}
                    <div className='join-us__table__container'>
                        <div  className='join-us__table__row'>
                            <div className='join-us__table__item'>
                                Issues Assets
                            </div>
                            <div className='join-us__table__item'>
                                Atomic Swaps
                ...
                <div  className='join-us__footer'>
                    ...
                    <div className='join-us__footer__item'>
                        ...
                        <p className='join-us__title join-us__footer__item__text'>Liquid Network Members (projects, exchanges, trading desks)</p>
                    </div>
                    <div className='join-us__footer__item'>
                        <h2 className='join-us__subTitle '>2890</h2>
                        <p className='join-us__title join-us__footer__item__text'>BTC pegged into the Liquid Network (as of May 2020)</p>
                    </div>
                    <div className='join-us__footer__item'>
                        <h2 className='join-us__subTitle '>$ 160M USD</h2>
                        <p className='join-us__title join-us__footer__item__text'>Total value pegged into the ecosystem (as of May 2020)</p>
                    </div>
                </div>
            </div>
            {/* <div className='FAQ'> */}
                ...
                <div className='FAQ__container'>
                    <details className='FAQ__details'>
                        <summary  className='FAQ__summary'>When is it beneficial to choose S-Corp?</summary>
